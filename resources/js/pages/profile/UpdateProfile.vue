...
const getUser = () => {
    axios.get(`/api/profile`).then((response) => {
        ...
        formData.avatar = authUserStore.user.avatar;
    });
};
                            ...
                            <ul class="nav nav-pills">
                                <li class="nav-item">
                                    <a
                                        ...
                                        data-toggle="tab"
                                    >
                                        <i class="bi bi-person-gear mr-1"></i> EditarPerfil
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a
                                        ...
                                        data-toggle="tab"
                                    >
                                        <i class="bi bi-key mr-1"></i> Cambiar contraseña
                                    </a>
                                </li>
                            </ul>
                        </div>
